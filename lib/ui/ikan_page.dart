        ...
        actions: [
          Padding(
            ...
            child: GestureDetector(
              ...
              onTap: () async {
                Navigator.push(context, MaterialPageRoute(builder: (context) => IkanForm()));
              },
            ),
          ),
        ],
...
class ItemIkan extends StatelessWidget {
  ...
  subtitle: Column( // Gunakan Column untuk mengelompokkan beberapa widget
    crossAxisAlignment: CrossAxisAlignment.start, // Posisikan teks ke kiri
    children: [
      Text(ikan.jenisIkan!),
      Text(ikan.warnaIkan!),
      Text(ikan.habitatIkan!),
    ],
  ),
),
